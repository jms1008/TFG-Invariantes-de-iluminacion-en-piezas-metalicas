function [] = comparacion_agrupamientos(imagen_tres_canales, imagen_resultado, img_ground_truth, nombre_imagen, tipo)
    ...
    figure()
    subplot(2,7,1); imshow(imagen_tres_canales); title('Imagen original');
    subplot(2,7,2); imshow(imagen_original_agrup_K_Means_uno); title(['Original K-Means ' num2str(porcentaje_original_agrup_K_Means_uno) '%']);
    subplot(2,7,3); imshow(imagen_original_agrup_C_Means_uno); title(['Original C-Means ' num2str(porcentaje_original_agrup_C_Means_uno) '%']);
    subplot(2,7,4); imshow(imagen_original_agrup_GMM_uno); title(['Original GMM ' num2str(porcentaje_original_agrup_GMM_uno) '%']);
    subplot(2,7,5); imshow(imagen_original_agrup_K_Means_dos); title(['Original K-Means ' num2str(porcentaje_original_agrup_K_Means_dos) '%']);
    subplot(2,7,6); imshow(imagen_original_agrup_C_Means_dos); title(['Original C-Means ' num2str(porcentaje_original_agrup_C_Means_dos) '%']);
    subplot(2,7,7); imshow(imagen_original_agrup_GMM_dos); title(['Original GMM ' num2str(porcentaje_original_agrup_GMM_dos) '%']);
    subplot(2,7,8); imshow(imagen_resultado); title('Imagen invariante');
    subplot(2,7,9); imshow(imagen_invariante_agrup_K_Means_uno); title(['Invariante K-Means ' num2str(porcentaje_invariante_agrup_K_Means_uno) '%']);
    subplot(2,7,10); imshow(imagen_invariante_agrup_C_Means_uno); title(['Invariante C-Means ' num2str(porcentaje_invariante_agrup_C_Means_uno) '%']);
    subplot(2,7,11); imshow(imagen_invariante_agrup_GMM_uno); title(['Invariante GMM ' num2str(porcentaje_invariante_agrup_GMM_uno) '%']);
    subplot(2,7,12); imshow(imagen_invariante_agrup_K_Means_dos); title(['Invariante K-Means ' num2str(porcentaje_invariante_agrup_K_Means_dos) '%']);
    subplot(2,7,13); imshow(imagen_invariante_agrup_C_Means_dos); title(['Invariante C-Means ' num2str(porcentaje_invariante_agrup_C_Means_dos) '%']);
    subplot(2,7,14); imshow(imagen_invariante_agrup_GMM_dos); title(['Invariante GMM ' num2str(porcentaje_invariante_agrup_GMM_dos) '%']);
    waitforbuttonpress;
    close();
    
    directorio_destino = '../Imagenes_resultado/Comparacion_agrup';
