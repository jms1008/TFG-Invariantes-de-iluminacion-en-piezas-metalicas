...
\imagen{img_ori_alv}{Resultado de aplicar el método de Álvarez et al sobre la imagen 3\_DIS\_1\_ACE\_TRO\_1}{1}
...
\imagen{img_ori_mad}{Resultado de aplicar el método de Maddern et al sobre la imagen 3\_DIS\_1\_ACE\_TRO\_1}{1}
...
\imagen{img_ori_kra}{Resultado de aplicar el método de Krajník et al sobre la imagen 3\_DIS\_1\_ACE\_TRO\_1}{1}
...
\imagen{img_ori_upc}{Resultado de aplicar el método de Upcroft et al sobre la imagen 3\_DIS\_1\_ACE\_TRO\_1}{1}
...
\imagen{img_ori_pca}{Resultado de aplicar PCA sobre la imagen 3\_DIS\_1\_ACE\_TRO\_1}{1}
