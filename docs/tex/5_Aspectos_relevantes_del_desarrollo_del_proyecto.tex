...
\imagen{kmeans_alvarez}{Tasa de acierto de los de la gemación aplicando K-Means sobre la imagen original frente a los resultados de utilizar previamente Álvarez.}{1}
...
\imagen{kmeans_todas}{Tasa de acierto de los de la gemación aplicando K-Means sobre la imagen original frente a los resultados de utilizar los distintos métodos invariantes.}{1}
